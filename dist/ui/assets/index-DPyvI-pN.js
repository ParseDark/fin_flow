...
`,_e=!1,ve=null,ye=[`https://cdn.jsdelivr.net/npm/highcharts@12/highcharts.js`,`https://code.highcharts.com/12/highcharts.js`];async function be(){_e||(_e=!0,await xe(),Function(ge)())}function xe(){return window.Highcharts?Promise.resolve():ve||(ve=Se(ye),ve)}function Se(e,t=0){return new Promise((n,r)=>{let i=e[t];if(!i){r(Error(`Highcharts 加载失败`));return}let a=document.querySelector(`script[data-finflow-highcharts="true"]`);if(a){a.addEventListener(`load`,n,{once:!0}),a.addEventListener(`error`,()=>Se(e,t+1).then(n,r),{once:!0});return}let o=document.createElement(`script`);o.src=i,o.async=!0,o.dataset.finflowHighcharts=`true`,o.addEventListener(`load`,n,{once:!0}),o.addEventListener(`error`,()=>{o.remove(),Se(e,t+1).then(n,r)},{once:!0}),document.head.appendChild(o)})}async function Ce(){let e=await fetch(`/api/status`,{cache:`no-store`});if(!e.ok)throw Error(`加载状态失败`);return e.json()}async function we(e){let t=e?`?date=${encodeURIComponent(e)}`:``,n=await fetch(`/api/finance${t}`,{cache:`no-store`});if(!n.ok)throw Error(`加载交易日数据失败`);return n.json()}function Te(){let[e,t]=(0,l.useState)(null),[n,r]=(0,l.useState)(null);(0,l.useEffect)(()=>{let e=!1;async function n(){try{let n=await we();e||(t(n),r(null))}catch(t){e||r(t)}}return n(),()=>{e=!0}},[]);let i=e?Math.max(0,Math.min(e.initialIndex||0,e.samples.length-1)):0,a=e?.samples?.[i]||null;return(0,l.useMemo)(()=>({data:e,error:n,index:i,sample:a,loading:!e&&!n}),[e,n,i,a])}var Ee=3e4;function De(){let[e,t]=(0,l.useState)(null);return(0,l.useEffect)(()=>{let e=!1;async function n(){if(document.visibilityState===`visible`)try{let n=await Ce();e||t(n)}catch{}}n();let r=setInterval(n,Ee);return document.addEventListener(`visibilitychange`,n),window.addEventListener(`focus`,n),window.addEventListener(`pageshow`,n),()=>{e=!0,clearInterval(r),document.removeEventListener(`visibilitychange`,n),window.removeEventListener(`focus`,n),window.removeEventListener(`pageshow`,n)}},[]),(0,l.useEffect)(()=>{e&&(Oe(`status-now`,e.chinaNow?.isoLike||`--`),Oe(`status-session`,ne(e.currentTradingSession)),Oe(`status-next-run`,re(e.nextRunAt)),Oe(`status-samples`,String(e.samplesToday??`--`)))},[e]),e}function Oe(e,t){let n=document.getElementById(e);n&&(n.textContent=t)}function ke(){let e=De(),t=Te();return(0,l.useEffect)(()=>{be().catch(e=>{console.error(e)})},[]),(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`style`,{children:d}),(0,p.jsxs)(`main`,{className:`page`,children:[(0,p.jsx)(ue,{status:e}),(0,p.jsx)(se,{}),(0,p.jsx)(fe,{data:t.data,sample:t.sample,loading:t.loading}),(0,p.jsx)(g,{loading:t.loading}),(0,p.jsx)(w,{sample:t.sample,loading:t.loading})]}),(0,p.jsx)(O,{})]})}var Ae=1e4;async function je(e){let t=await Promise.allSettled(e.map(async e=>{let t=`/api/tline?code=${encodeURIComponent(e)}`,n=await fetch(t,{cache:`no-store`});if(!n.ok)throw Error(`HTTP ${n.status} for ${e}`);return{code:e,data:await n.json()}})),n=new Map;for(let e of t)e.status===`fulfilled`&&n.set(e.value.code,e.value.data);return n}function Me(e){let t=new URLSearchParams(e),n={};for(let[e,r]of t.entries()){if(!e.startsWith(`group`))continue;let t=r.replace(/^\[|\]$/g,``).trim();if(!t)continue;let i=t.split(`,`).map(e=>e.trim()).filter(Boolean);i.length>0&&(n[e]=i)}return n}function Ne(e){if(!e)return[];let t=e?.data?.line;return Array.isArray(t)?t.map(e=>({time:e.minute,price:e.last_px,avg:e.av_px,volume:e.business_amount,amount:e.business_balance,change:e.change,changePx:e.change_px})):[]}function Pe(e){return e?.data?.name||e?.data?.secu_name||``}function Fe(e){return e?.data?.preclose_px??null}function Ie(e){let[t,n]=(0,l.useState)(new Map),[r,i]=(0,l.useState)(new Map),[a,o]=(0,l.useState)(!0),[s,c]=(0,l.useState)(null),u=(0,l.useRef)(null),d=(0,l.useCallback)(async()=>{if(e.length!==0)try{let t=await je(e);n(e=>{let n=new Map(e);for(let[e,r]of t)n.set(e,Ne(r));return n}),i(e=>{let n=new Map(e);for(let[e,r]of t)n.set(e,{name:Pe(r),prevClose:Fe(r)});return n}),c(null)}catch(e){c(e)}finally{o(!1)}},[e.join(`,`)]);return(0,l.useEffect)(()=>{if(e.length===0){o(!1);return}return o(!0),d(),u.current=setInterval(d,Ae),()=>{u.current&&clearInterval(u.current)}},[d,e.join(`,`)]),{seriesMap:t,metaMap:r,loading:a,error:s,refresh:d}}var Le=[`#4f8cff`,`#ff6b6b`,`#51cf66`,`#ffd43b`,`#cc5de8`,`#20c997`,`#ff922b`,`#748ffc`],Re=960,k={top:24,right:80,bottom:36,left:64},ze=Re-k.left-k.right;function Be(){let e=(0,l.useMemo)(()=>Me(window.location.search),[]),{seriesMap:t,metaMap:n,loading:r,error:i}=Ie((0,l.useMemo)(()=>{let t=new Set;for(let n of Object.values(e))for(let e of n)t.add(e);return[...t]},[e]));return Object.keys(e).length===0?(0,p.jsx)(`main`,{className:`page`,children:(0,p.jsxs)(`section`,{className:`panel`,style:{maxWidth:560,margin:`80px auto`,textAlign:`center`},children:[(0,p.jsx)(`div`,{className:`eyebrow`,children:`Stock Tline Compare`}),(0,p.jsx)(`h1`,{style:{fontSize:28,marginBottom:16},children:`分时对比工具`}),(0,p.jsx)(`p`,{className:`lead`,style:{marginBottom:20},children:`通过 URL 参数指定股票分组，在同一坐标轴内对比分时走势。`}),(0,p.jsx)(`div`,{style:{padding:14,background:`rgba(63,63,70,0.04)`,borderRadius:12,fontFamily:`monospace`,fontSize:13,color:`var(--muted)`},children:`/tline?group1=sz002008,sz300750&group2=sz600519`})]})}):(0,p.jsxs)(`main`,{className:`page tline-page`,children:[(0,p.jsx)(Ve,{groups:e,loading:r}),(0,p.jsx)(Ue,{groups:e,seriesMap:t,metaMap:n,loading:r}),(0,p.jsx)(We,{groups:e,seriesMap:t,metaMap:n,loading:r}),(0,p.jsx)(Ke,{groups:e,seriesMap:t,metaMap:n}),i&&(0,p.jsxs)(`div`,{className:`tline-error`,children:[`部分数据加载失败：`,i.message]})]})}function Ve({groups:e,loading:t}){let n=Object.values(e).reduce((e,t)=>e+t.length,0);return(0,p.jsxs)(`section`,{className:`panel hero-copy`,style:{marginBottom:16},children:[(0,p.jsxs)(`div`,{className:`eyebrow`,children:[`Stock Tline / `,n,` Symbols`]}),(0,p.jsx)(`h1`,{style:{fontSize:48,marginBottom:12},children:`分时走势对比`}),(0,p.jsx)(`p`,{className:`lead`,children:Object.entries(e).map(([e,t])=>(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`strong`,{children:e}),`: `,t.join(`, `),` `]},e))}),(0,p.jsxs)(`div`,{className:`status-rail`,style:{marginTop:16},children:[(0,p.jsx)(He,{label:`股票数量`,value:`${n} 只`}),(0,p.jsx)(He,{label:`刷新频率`,value:`10 秒`}),(0,p.jsx)(He,{label:`数据状态`,value:t?`加载中...`:`实时`}),(0,p.jsx)(He,{label:`对比维度`,value:`涨跌幅 %`})]})]})}function He({label:e,value:t}){return(0,p.jsxs)(`div`,{className:`status-pill`,children:[(0,p.jsx)(`div`,{className:`label`,children:e}),(0,p.jsx)(`div`,{className:`value`,children:t})]})}function Ue({groups:e,seriesMap:t,metaMap:n,loading:r}){let[i,a]=(0,l.useState)(null),o=(0,l.useRef)(null),{minPct:s,maxPct:c,lines:u}=(0,l.useMemo)(()=>{let r=1/0,i=-1/0,a=[],o=Object.entries(e);for(let e=0;e<o.length;e++){let[s,c]=o[e];for(let o=0;o<c.length;o++){let l=c[o],u=t.get(l)||[],d=n.get(l)||{},f=Le[(e*5+o)%Le.length],p=o>0?`${3+o*2} ${2+o}`:void 0,m=d.prevClose,h=u.map(e=>{if(m&&e.price!=null){let t=(e.price-m)/m*100;return t<r&&(r=t),t>i&&(i=t),{...e,pct:t}}return{...e,pct:0}});a.push({code:l,name:d.name||l,groupName:s,series:h,color:f,dashArray:p})}}isFinite(r)||(r=-1,i=1);let s=(i-r)*.1||.5;return{minPct:r-s,maxPct:i+s,lines:a}},[e,t,n]),d=360-k.top-k.bottom,f=u.length>0?Math.max(...u.map(e=>e.series.length)):1,m=e=>k.left+e/Math.max(1,f-1)*ze,h=e=>k.top+(c-e)/(c-s)*d,g=(0,l.useCallback)(e=>{if(!o.current||u.length===0)return;let t=o.current.getBoundingClientRect(),n=(e.clientX-t.left)/t.width*Re,r=Math.round((n-k.left)/ze*(f-1));if(r<0||r>=f){a(null);return}let i=u.map(e=>{let t=e.series[r];return t?{name:e.name,color:e.color,price:t.price,pct:t.pct,time:t.time,amount:t.amount}:null}).filter(Boolean);if(i.length===0){a(null);return}a({x:m(r),time:i[0]?.time,items:i,side:m(r)>Re/2?`left`:`right`})},[u,f,Re,ze,m]),_=(0,l.useCallback)(()=>a(null),[]);if(u.length===0)return(0,p.jsx)(Ge,{title:`日内分时走势`,desc:`涨跌幅对比`,loading:r});let v=[],y=(c-s)/5;for(let e=0;e<=5;e++)v.push(s+y*e);let b=u.find(e=>e.series.length>0),x=[];if(b){let e=Math.max(1,Math.floor(b.series.length/6));for(let t=0;t<b.series.length;t+=e)x.push({x:m(t),label:qe(b.series[t].time)});let t=b.series.length-1,n=qe(b.series[t].time);(x.length===0||x[x.length-1].label!==n)&&x.push({x:m(t),label:n})}let ee=s<=0&&c>=0?h(0):null;return(0,p.jsxs)(`section`,{className:`panel chart-panel loading-dim`,"aria-busy":r?`true`:`false`,children:[(0,p.jsx)(`div`,{className:`chart-head`,children:(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`div`,{className:`chart-title`,children:`日内分时走势`}),(0,p.jsx)(`div`,{className:`chart-note`,children:`涨跌幅对比（基于昨收价）`}),(0,p.jsx)(`div`,{className:`chart-stats`,children:(0,p.jsx)(`span`,{className:`chart-filter-tags`,children:u.map(e=>(0,p.jsxs)(`span`,{className:`chart-legend-item`,style:{color:e.color},children:[(0,p.jsx)(`span`,{className:`chart-legend-swatch`,style:{background:e.color}}),e.name]},e.code))})})]})}),(0,p.jsxs)(`div`,{className:`tline-chart-wrapper`,style:{position:`relative`},children:[(0,p.jsxs)(`svg`,{ref:o,viewBox:`0 0 ${Re} 360`,className:`tline-svg`,preserveAspectRatio:`xMidYMid meet`,onMouseMove:g,onMouseLeave:_,style:{cursor:`crosshair`},children:[v.map(e=>(0,p.jsxs)(`g`,{children:[(0,p.jsx)(`line`,{x1:k.left,x2:Re-k.right,y1:h(e),y2:h(e),className:`tline-grid-line`}),(0,p.jsxs)(`text`,{x:k.left-8,y:h(e),textAnchor:`end`,dominantBaseline:`middle`,className:`tline-axis-label`,children:[e>=0?`+`:``,e.toFixed(2),`%`]})]},e)),ee!=null&&(0,p.jsxs)(`g`,{children:[(0,p.jsx)(`line`,{x1:k.left,x2:Re-k.right,y1:ee,y2:ee,className:`tline-prev-close`}),(0,p.jsx)(`text`,{x:Re-k.right+6,y:ee,dominantBaseline:`middle`,className:`tline-axis-label`,style:{fontSize:10},children:`0%`})]}),u.map(e=>e.series.length===0?null:(0,p.jsx)(`path`,{d:e.series.map((e,t)=>`${t===0?`M`:`L`}${m(t)},${h(e.pct)}`).join(` `),fill:`none`,stroke:e.color,strokeWidth:1.5,strokeDasharray:e.dashArray,className:`tline-path`},e.code)),u.map(e=>{if(e.series.length===0)return null;let t=e.series.length-1;return(0,p.jsx)(`circle`,{cx:m(t),cy:h(e.series[t].pct),r:4,fill:e.color,stroke:`rgba(24,24,27,0.9)`,strokeWidth:2},`dot-${e.code}`)}),x.map(e=>(0,p.jsx)(`text`,{x:e.x,y:354,textAnchor:`middle`,className:`tline-axis-label`,children:e.label},e.label)),i&&(0,p.jsxs)(`g`,{children:[(0,p.jsx)(`line`,{x1:i.x,x2:i.x,y1:k.top,y2:360-k.bottom,stroke:`rgba(244,244,245,0.3)`,strokeWidth:1,strokeDasharray:`4 4`,pointerEvents:`none`}),i.items.map((e,t)=>(0,p.jsx)(`circle`,{cx:i.x,cy:h(e.pct),r:5,fill:e.color,stroke:`rgba(24,24,27,0.9)`,strokeWidth:2,pointerEvents:`none`},t))]}),(0,p.jsx)(`rect`,{x:k.left,y:k.top,width:ze,height:d,fill:`transparent`})]}),i&&(0,p.jsxs)(`div`,{className:`tline-tooltip`,style:{position:`absolute`,top:10,[i.side===`left`?`right`:`left`]:90,pointerEvents:`none`},children:[(0,p.jsx)(`div`,{className:`tline-tooltip-time`,children:qe(i.time)}),i.items.map((e,t)=>(0,p.jsxs)(`div`,{className:`tline-tooltip-row`,children:[(0,p.jsx)(`span`,{className:`tline-tooltip-dot`,style:{background:e.color}}),(0,p.jsx)(`span`,{className:`tline-tooltip-name`,children:e.name}),(0,p.jsxs)(`span`,{className:`tline-tooltip-pct`,style:{color:e.pct>=0?`var(--up)`:`var(--down)`},children:[e.pct>=0?`+`:``,e.pct.toFixed(2),`%`]}),(0,p.jsx)(`span`,{className:`tline-tooltip-price`,children:e.price?.toFixed(2)})]},t))]})]}),(0,p.jsx)(`div`,{className:`scrubber`,children:(0,p.jsxs)(`div`,{className:`scrubber-head`,children:[(0,p.jsx)(`div`,{className:`muted`,children:`鼠标悬停查看详情`}),(0,p.jsx)(`kbd`,{children:`实时`})]})})]})}function We({groups:e,seriesMap:t,metaMap:n,loading:r}){let{lines:i}=(0,l.useMemo)(()=>{let r=[],i=Object.entries(e);for(let e=0;e<i.length;e++){let[a,o]=i[e];for(let i=0;i<o.length;i++){let a=o[i],s=t.get(a)||[],c=n.get(a)||{},l=Le[(e*5+i)%Le.length],u=0;for(let e of s)e.amount>u&&(u=e.amount);u===0&&(u=1),r.push({code:a,name:c.name||a,series:s,color:l,maxAmount:u})}}return{lines:r}},[e,t,n]),a=180-k.top-k.bottom,o=i.length>0?Math.max(...i.map(e=>e.series.length)):1,s=e=>k.left+e/Math.max(1,o-1)*ze;if(i.length===0)return(0,p.jsx)(Ge,{title:`成交额`,desc:`各股票每分钟成交额`,loading:r});let c=Math.max(1,Math.ceil(o/100)),u=Math.ceil(o/c),d=Math.max(3,ze/u*.6/i.length),f=d*i.length;return i.map(e=>e.maxAmount),(0,p.jsxs)(`section`,{className:`panel chart-panel loading-dim`,"aria-busy":r?`true`:`false`,children:[(0,p.jsx)(`div`,{className:`chart-head`,children:(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`div`,{className:`chart-title`,style:{fontSize:22},children:`成交额`}),(0,p.jsx)(`div`,{className:`chart-note`,children:`各股票每分钟成交额（柱状图独立缩放）`}),(0,p.jsx)(`div`,{className:`chart-stats`,children:(0,p.jsx)(`span`,{className:`chart-filter-tags`,children:i.map(e=>(0,p.jsxs)(`span`,{className:`chart-legend-item`,style:{color:e.color},children:[(0,p.jsx)(`span`,{className:`chart-legend-swatch`,style:{background:e.color}}),e.name,(0,p.jsxs)(`span`,{className:`muted`,style:{fontSize:10},children:[`max `,Ye(e.maxAmount)]})]},e.code))})})]})}),(0,p.jsx)(`div`,{className:`tline-chart-wrapper`,children:(0,p.jsxs)(`svg`,{viewBox:`0 0 ${Re} 180`,className:`tline-svg`,preserveAspectRatio:`xMidYMid meet`,children:[[0,.25,.5,.75,1].map(e=>{let t=k.top+(1-e)*a;return(0,p.jsxs)(`g`,{children:[(0,p.jsx)(`line`,{x1:k.left,x2:Re-k.right,y1:t,y2:t,className:`tline-grid-line`}),(0,p.jsxs)(`text`,{x:k.left-8,y:t,textAnchor:`end`,dominantBaseline:`middle`,className:`tline-axis-label`,children:[Math.round(e*100),`%`]})]},e)}),i.map((e,t)=>e.series.length===0?null:e.series.filter((e,t)=>t%c===0).map((n,r)=>{let i=s(r*c)-f/2+t*d,o=n.amount/e.maxAmount,l=Math.max(1.5,o*a);return(0,p.jsx)(`rect`,{x:i,y:k.top+a-l,width:Math.max(2,d-1),height:l,fill:e.color,opacity:.7,rx:0},`vol-${e.code}-${r}`)})),(()=>{let e=i.find(e=>e.series.length>0);if(!e)return null;let t=Math.max(1,Math.floor(e.series.length/6));return e.series.filter((e,n)=>n%t===0).map((e,n)=>(0,p.jsx)(`text`,{x:s(n*t),y:174,textAnchor:`middle`,className:`tline-axis-label`,children:qe(e.time)},n))})()]})})]})}function Ge({title:e,desc:t,loading:n}){return(0,p.jsxs)(`section`,{className:`panel chart-panel`,children:[(0,p.jsx)(`div`,{className:`chart-head`,children:(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`div`,{className:`chart-title`,children:e}),(0,p.jsx)(`div`,{className:`chart-note`,children:t})]})}),(0,p.jsx)(`div`,{className:`tline-chart-wrapper`,children:n?(0,p.jsx)(`div`,{className:`tline-skeleton`}):(0,p.jsx)(`div`,{style:{padding:40,textAlign:`center`,color:`var(--muted)`},children:`暂无数据`})})]})}function Ke({groups:e,seriesMap:t,metaMap:n}){let r=[],i=Object.entries(e);for(let e=0;e<i.length;e++){let[a,o]=i[e];for(let e of o){let i=t.get(e)||[],o=i.length>0?i[i.length-1]:null;r.push({groupName:a,code:e,name:n.get(e)?.name||e,price:o?.price??null,changePct:o?.change??null,volume:o?.amount??null})}}return(0,p.jsxs)(`section`,{className:`panel`,style:{marginTop:16},children:[(0,p.jsx)(`div`,{className:`chart-head`,children:(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`div`,{className:`chart-title`,style:{fontSize:22},children:`实时行情`}),(0,p.jsx)(`div`,{className:`chart-note`,children:`各股票最新价格和涨跌幅`})]})}),(0,p.jsxs)(`table`,{className:`tline-table`,children:[(0,p.jsx)(`thead`,{children:(0,p.jsxs)(`tr`,{children:[(0,p.jsx)(`th`,{children:`分组`}),(0,p.jsx)(`th`,{children:`代码`}),(0,p.jsx)(`th`,{children:`名称`}),(0,p.jsx)(`th`,{children:`最新价`}),(0,p.jsx)(`th`,{children:`涨跌幅`}),(0,p.jsx)(`th`,{children:`成交额`})]})}),(0,p.jsx)(`tbody`,{children:r.map(e=>{let t=e.changePct==null?``:e.changePct>=0?`up`:`down`;return(0,p.jsxs)(`tr`,{children:[(0,p.jsx)(`td`,{children:(0,p.jsx)(`span`,{className:`badge`,children:e.groupName})}),(0,p.jsx)(`td`,{className:`muted`,children:e.code}),(0,p.jsx)(`td`,{children:(0,p.jsx)(`strong`,{children:e.name})}),(0,p.jsx)(`td`,{children:e.price==null?`-`:e.price.toFixed(2)}),(0,p.jsx)(`td`,{className:t,children:e.changePct==null?`-`:Je(e.changePct)}),(0,p.jsx)(`td`,{className:`muted`,children:e.volume==null?`-`:Ye(e.volume)})]},e.code)})})]})]})}function qe(e){if(e==null)return``;let t=String(e).padStart(4,`0`);return`${t.slice(0,2)}:${t.slice(2,4)}`}function Je(e){return e==null?`-`:`${e>=0?`+`:``}${e.toFixed(2)}%`}function Ye(e){return e==null?`-`:e>=1e8?`${(e/1e8).toFixed(2)}亿`:e>=1e4?`${(e/1e4).toFixed(0)}万`:String(e)}function Xe(){let e=window.location.pathname;return e===`/tline`||e.startsWith(`/tline/`)?`tline`:`home`}function Ze(){return Xe()===`tline`?(0,p.jsx)(Be,{}):(0,p.jsx)(ke,{})}(0,u.createRoot)(document.getElementById(`app`)).render((0,p.jsx)(Ze,{}));
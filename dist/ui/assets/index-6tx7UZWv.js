...
`,_e=!1,ve=null,ye=[`https://cdn.jsdelivr.net/npm/highcharts@12/highcharts.js`,`https://code.highcharts.com/12/highcharts.js`];async function be(){_e||(_e=!0,await xe(),Function(ge)())}function xe(){return window.Highcharts?Promise.resolve():ve||(ve=Se(ye),ve)}function Se(e,t=0){return new Promise((n,r)=>{let i=e[t];if(!i){r(Error(`Highcharts 加载失败`));return}let a=document.querySelector(`script[data-finflow-highcharts="true"]`);if(a){a.addEventListener(`load`,n,{once:!0}),a.addEventListener(`error`,()=>Se(e,t+1).then(n,r),{once:!0});return}let o=document.createElement(`script`);o.src=i,o.async=!0,o.dataset.finflowHighcharts=`true`,o.addEventListener(`load`,n,{once:!0}),o.addEventListener(`error`,()=>{o.remove(),Se(e,t+1).then(n,r)},{once:!0}),document.head.appendChild(o)})}async function Ce(){let e=await fetch(`/api/status`,{cache:`no-store`});if(!e.ok)throw Error(`加载状态失败`);return e.json()}async function we(){let e=await fetch(`/api/analytics`,{cache:`no-store`});if(!e.ok)throw Error(`加载访问统计失败`);return e.json()}async function Te(e){let t=e?`?date=${encodeURIComponent(e)}`:``,n=await fetch(`/api/finance${t}`,{cache:`no-store`});if(!n.ok)throw Error(`加载交易日数据失败`);return n.json()}function Ee(){let[e,t]=(0,l.useState)(null),[n,r]=(0,l.useState)(null);(0,l.useEffect)(()=>{let e=!1;async function n(){try{let n=await Te();e||(t(n),r(null))}catch(t){e||r(t)}}return n(),()=>{e=!0}},[]);let i=e?Math.max(0,Math.min(e.initialIndex||0,e.samples.length-1)):0,a=e?.samples?.[i]||null;return(0,l.useMemo)(()=>({data:e,error:n,index:i,sample:a,loading:!e&&!n}),[e,n,i,a])}var De=3e4;function Oe(){let[e,t]=(0,l.useState)(null);return(0,l.useEffect)(()=>{let e=!1;async function n(){if(document.visibilityState===`visible`)try{let n=await Ce();e||t(n)}catch{}}n();let r=setInterval(n,De);return document.addEventListener(`visibilitychange`,n),window.addEventListener(`focus`,n),window.addEventListener(`pageshow`,n),()=>{e=!0,clearInterval(r),document.removeEventListener(`visibilitychange`,n),window.removeEventListener(`focus`,n),window.removeEventListener(`pageshow`,n)}},[]),(0,l.useEffect)(()=>{e&&(ke(`status-now`,e.chinaNow?.isoLike||`--`),ke(`status-session`,ne(e.currentTradingSession)),ke(`status-next-run`,re(e.nextRunAt)),ke(`status-samples`,String(e.samplesToday??`--`)))},[e]),e}function ke(e,t){let n=document.getElementById(e);n&&(n.textContent=t)}var Ae=300*1e3;function je(){let[e,t]=(0,l.useState)(null);return(0,l.useEffect)(()=>{let e=!1;async function n(){if(document.visibilityState===`visible`)try{let n=await we();!e&&!n.error&&t(n)}catch{}}n();let r=setInterval(n,Ae);return()=>{e=!0,clearInterval(r)}},[]),e}function Me(){let e=Oe(),t=je(),n=Ee();return(0,l.useEffect)(()=>{be().catch(e=>{console.error(e)})},[]),(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`style`,{children:d}),(0,p.jsxs)(`main`,{className:`page`,children:[(0,p.jsx)(ue,{status:e,analytics:t}),(0,p.jsx)(se,{}),(0,p.jsx)(fe,{data:n.data,sample:n.sample,loading:n.loading}),(0,p.jsx)(g,{loading:n.loading}),(0,p.jsx)(w,{sample:n.sample,loading:n.loading})]}),(0,p.jsx)(O,{})]})}var Ne=1e4;function Pe(){let e=new Date(new Date().toLocaleString(`en-US`,{timeZone:`Asia/Shanghai`})),t=e.getHours(),n=e.getMinutes(),r=e.getDay();if(r===0||r===6)return!1;let i=t*60+n;return i>=540&&i<=695||i>=780&&i<=930}async function Fe(e){let t=await Promise.allSettled(e.map(async e=>{let t=`/api/tline?code=${encodeURIComponent(e)}`,n=await fetch(t,{cache:`no-store`});if(!n.ok)throw Error(`HTTP ${n.status} for ${e}`);return{code:e,data:await n.json()}})),n=new Map;for(let e of t)e.status===`fulfilled`&&n.set(e.value.code,e.value.data);return n}function Ie(e){let t=new URLSearchParams(e),n={};for(let[e,r]of t.entries()){if(!e.startsWith(`group`))continue;let t=r.replace(/^\[|\]$/g,``).trim();if(!t)continue;let i=t.split(`,`).map(e=>e.trim()).filter(Boolean);i.length>0&&(n[e]=i)}return n}function Le(e){if(!e)return[];let t=e?.data?.line;return Array.isArray(t)?t.map(e=>({time:e.minute,price:e.last_px,avg:e.av_px,volume:e.business_amount,amount:e.business_balance,change:e.change,changePx:e.change_px})):[]}function Re(e){return e?.data?.name||e?.data?.secu_name||``}function ze(e){return e?.data?.preclose_px??null}function Be(e){let[t,n]=(0,l.useState)(new Map),[r,i]=(0,l.useState)(new Map),[a,o]=(0,l.useState)(!0),[s,c]=(0,l.useState)(null),[u,d]=(0,l.useState)(Pe()),f=(0,l.useRef)(null),p=(0,l.useCallback)(async()=>{if(e.length!==0)try{let t=await Fe(e);n(e=>{let n=new Map(e);for(let[e,r]of t)n.set(e,Le(r));return n}),i(e=>{let n=new Map(e);for(let[e,r]of t)n.set(e,{name:Re(r),prevClose:ze(r)});return n}),c(null)}catch(e){c(e)}finally{o(!1)}},[e.join(`,`)]);return(0,l.useEffect)(()=>{if(e.length===0){o(!1);return}return o(!0),p(),u&&(f.current=setInterval(p,Ne)),()=>{f.current&&clearInterval(f.current)}},[p,e.join(`,`),u]),(0,l.useEffect)(()=>{let e=setInterval(()=>{let e=Pe();e!==u&&d(e)},6e4);return()=>clearInterval(e)},[u]),{seriesMap:t,metaMap:r,loading:a,error:s,refresh:p,tradingTime:u}}var Ve=[`#4f8cff`,`#ff6b6b`,`#51cf66`,`#ffd43b`,`#cc5de8`,`#20c997`,`#ff922b`,`#748ffc`],He=960,k={top:24,right:80,bottom:36,left:64},Ue=He-k.left-k.right,We=271;function Ge(){let e=(0,l.useMemo)(()=>Ie(window.location.search),[]),{seriesMap:t,metaMap:n,loading:r,error:i,tradingTime:a}=Be((0,l.useMemo)(()=>{let t=new Set;for(let n of Object.values(e))for(let e of n)t.add(e);return[...t]},[e]));if(Object.keys(e).length===0)return(0,p.jsx)(`main`,{className:`page`,children:(0,p.jsxs)(`section`,{className:`panel`,style:{maxWidth:560,margin:`80px auto`,textAlign:`center`},children:[(0,p.jsx)(`div`,{className:`eyebrow`,children:`Stock Tline Compare`}),(0,p.jsx)(`h1`,{style:{fontSize:28,marginBottom:16},children:`分时对比工具`}),(0,p.jsx)(`p`,{className:`lead`,style:{marginBottom:20},children:`通过 URL 参数指定股票分组，按组对比分时走势和成交量。`}),(0,p.jsx)(`div`,{style:{padding:14,background:`rgba(63,63,70,0.04)`,borderRadius:12,fontFamily:`monospace`,fontSize:13,color:`var(--muted)`},children:`/tline?group1=sz002008,sz300750&group2=sz600519`})]})});let o=Object.entries(e);return(0,p.jsxs)(`main`,{className:`page tline-page`,children:[(0,p.jsx)(Ke,{groups:e,loading:r,tradingTime:a}),o.map(([e,i],a)=>(0,p.jsx)(Je,{groupName:e,codes:i,groupIndex:a,seriesMap:t,metaMap:n,loading:r},e)),(0,p.jsx)(Ze,{groups:e,seriesMap:t,metaMap:n}),i&&(0,p.jsxs)(`div`,{className:`tline-error`,children:[`部分数据加载失败：`,i.message]})]})}function Ke({groups:e,loading:t,tradingTime:n}){let r=Object.values(e).reduce((e,t)=>e+t.length,0),i=n?`交易时段 · 每10秒刷新`:`非交易时段 · 仅加载一次`;return(0,p.jsxs)(`section`,{className:`panel hero-copy`,style:{marginBottom:16},children:[(0,p.jsxs)(`div`,{className:`eyebrow`,children:[`Stock Tline / `,r,` Symbols`]}),(0,p.jsx)(`h1`,{style:{fontSize:48,marginBottom:12},children:`分时走势对比`}),(0,p.jsx)(`p`,{className:`lead`,children:Object.entries(e).map(([e,t])=>(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`strong`,{children:e}),`: `,t.join(`, `),` `]},e))}),(0,p.jsxs)(`div`,{className:`status-rail`,style:{marginTop:16},children:[(0,p.jsx)(qe,{label:`股票数量`,value:`${r} 只`}),(0,p.jsx)(qe,{label:`刷新状态`,value:t?`加载中...`:i}),(0,p.jsx)(qe,{label:`数据状态`,value:n?`🟢 交易中`:`⚪ 休市`}),(0,p.jsx)(qe,{label:`对比维度`,value:`涨跌幅 %`})]})]})}function qe({label:e,value:t}){return(0,p.jsxs)(`div`,{className:`status-pill`,children:[(0,p.jsx)(`div`,{className:`label`,children:e}),(0,p.jsx)(`div`,{className:`value`,children:t})]})}function Je({groupName:e,codes:t,groupIndex:n,seriesMap:r,metaMap:i,loading:a}){let{minPct:o,maxPct:s,lines:c}=(0,l.useMemo)(()=>{let a=1/0,o=-1/0,s=[];for(let c=0;c<t.length;c++){let l=t[c],u=r.get(l)||[],d=i.get(l)||{},f=Ve[(n*5+c)%Ve.length],p=c>0?`${3+c*2} ${2+c}`:void 0,m=d.prevClose,h=u.map(e=>{if(m&&e.price!=null){let t=(e.price-m)/m*100;return t<a&&(a=t),t>o&&(o=t),{...e,pct:t}}return{...e,pct:0}});s.push({code:l,name:d.name||l,groupName:e,series:h,color:f,dashArray:p})}isFinite(a)||(a=-1,o=1);let c=(o-a)*.1||.5;return{minPct:a-c,maxPct:o+c,lines:s}},[t,n,r,i]);return c.length===0?(0,p.jsx)(`section`,{className:`panel chart-panel`,children:(0,p.jsx)(`div`,{className:`chart-head`,children:(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`div`,{className:`chart-title`,children:e}),(0,p.jsx)(`div`,{className:`chart-note`,children:`暂无数据`})]})})}):(0,p.jsxs)(`section`,{className:`panel chart-panel loading-dim`,"aria-busy":a?`true`:`false`,style:{marginBottom:16},children:[(0,p.jsx)(`div`,{className:`chart-head`,children:(0,p.jsxs)(`div`,{children:[(0,p.jsxs)(`div`,{className:`chart-title`,style:{display:`flex`,alignItems:`center`,gap:10},children:[(0,p.jsx)(`span`,{className:`badge`,style:{fontSize:14,padding:`2px 10px`},children:e}),(0,p.jsx)(`span`,{children:`分时走势 + 成交量`})]}),(0,p.jsx)(`div`,{className:`chart-stats`,style:{marginTop:6},children:c.map(e=>(0,p.jsxs)(`span`,{className:`chart-legend-item`,style:{color:e.color},children:[(0,p.jsx)(`span`,{className:`chart-legend-swatch`,style:{background:e.color}}),e.name]},e.code))})]})}),(0,p.jsx)(Ye,{lines:c,minPct:o,maxPct:s}),(0,p.jsx)(Xe,{lines:c,seriesMap:r,codes:t})]})}function Ye({lines:e,minPct:t,maxPct:n}){let[r,i]=(0,l.useState)(null),a=(0,l.useRef)(null),o=320-k.top-k.bottom,s=e.length>0?Math.max(...e.map(e=>e.series.length)):1,c=Math.max(s,We),u=e=>k.left+e/Math.max(1,c-1)*Ue,d=e=>k.top+(n-e)/(n-t)*o,f=(0,l.useCallback)(t=>{if(!a.current||e.length===0)return;let n=a.current.getBoundingClientRect(),r=(t.clientX-n.left)/n.width*He,o=Math.round((r-k.left)/Ue*(c-1));if(o<0||o>=c){i(null);return}let s=e.map(e=>{let t=e.series[o];return t?{name:e.name,color:e.color,price:t.price,pct:t.pct,time:t.time,amount:t.amount}:null}).filter(Boolean);if(s.length===0){i(null);return}i({x:u(o),time:s[0]?.time,items:s,side:u(o)>He/2?`left`:`right`})},[e,c,He,Ue,u]),m=(0,l.useCallback)(()=>i(null),[]),h=[],g=(n-t)/5;for(let e=0;e<=5;e++)h.push(t+g*e);let _=t<=0&&n>=0?d(0):null,v=Qe(c,u);return(0,p.jsxs)(`div`,{className:`tline-chart-wrapper`,style:{position:`relative`},children:[(0,p.jsx)(`div`,{style:{padding:`0 16px`,fontSize:12,color:`var(--muted)`,marginBottom:4},children:`涨跌幅 (%)`}),(0,p.jsxs)(`svg`,{ref:a,viewBox:`0 0 ${He} 320`,className:`tline-svg`,preserveAspectRatio:`xMidYMid meet`,onMouseMove:f,onMouseLeave:m,style:{cursor:`crosshair`},children:[h.map(e=>(0,p.jsxs)(`g`,{children:[(0,p.jsx)(`line`,{x1:k.left,x2:He-k.right,y1:d(e),y2:d(e),className:`tline-grid-line`}),(0,p.jsxs)(`text`,{x:k.left-8,y:d(e),textAnchor:`end`,dominantBaseline:`middle`,className:`tline-axis-label`,children:[e>=0?`+`:``,e.toFixed(2),`%`]})]},e)),_!=null&&(0,p.jsxs)(`g`,{children:[(0,p.jsx)(`line`,{x1:k.left,x2:He-k.right,y1:_,y2:_,className:`tline-prev-close`}),(0,p.jsx)(`text`,{x:He-k.right+6,y:_,dominantBaseline:`middle`,className:`tline-axis-label`,style:{fontSize:10},children:`0%`})]}),e.map(e=>e.series.length===0?null:(0,p.jsx)(`path`,{d:e.series.map((e,t)=>`${t===0?`M`:`L`}${u(t)},${d(e.pct)}`).join(` `),fill:`none`,stroke:e.color,strokeWidth:1.8,strokeDasharray:e.dashArray,className:`tline-path`},e.code)),e.map(e=>{if(e.series.length===0)return null;let t=e.series.length-1;return(0,p.jsx)(`circle`,{cx:u(t),cy:d(e.series[t].pct),r:4,fill:e.color,stroke:`rgba(24,24,27,0.9)`,strokeWidth:2},`dot-${e.code}`)}),v.map(e=>(0,p.jsx)(`text`,{x:e.x,y:314,textAnchor:`middle`,className:`tline-axis-label`,children:e.label},e.label)),r&&(0,p.jsxs)(`g`,{children:[(0,p.jsx)(`line`,{x1:r.x,x2:r.x,y1:k.top,y2:320-k.bottom,stroke:`rgba(244,244,245,0.3)`,strokeWidth:1,strokeDasharray:`4 4`,pointerEvents:`none`}),r.items.map((e,t)=>(0,p.jsx)(`circle`,{cx:r.x,cy:d(e.pct),r:5,fill:e.color,stroke:`rgba(24,24,27,0.9)`,strokeWidth:2,pointerEvents:`none`},t))]}),(0,p.jsx)(`rect`,{x:k.left,y:k.top,width:Ue,height:o,fill:`transparent`})]}),r&&(0,p.jsxs)(`div`,{className:`tline-tooltip`,style:{position:`absolute`,top:10,[r.side===`left`?`right`:`left`]:90,pointerEvents:`none`},children:[(0,p.jsx)(`div`,{className:`tline-tooltip-time`,children:$e(r.time)}),r.items.map((e,t)=>(0,p.jsxs)(`div`,{className:`tline-tooltip-row`,children:[(0,p.jsx)(`span`,{className:`tline-tooltip-dot`,style:{background:e.color}}),(0,p.jsx)(`span`,{className:`tline-tooltip-name`,children:e.name}),(0,p.jsxs)(`span`,{className:`tline-tooltip-pct`,style:{color:e.pct>=0?`var(--up)`:`var(--down)`},children:[e.pct>=0?`+`:``,e.pct.toFixed(2),`%`]}),(0,p.jsx)(`span`,{className:`tline-tooltip-price`,children:e.price?.toFixed(2)})]},t))]})]})}function Xe({lines:e,seriesMap:t,codes:n}){let r=160-k.top-k.bottom,i=e.length>0?Math.max(...e.map(e=>e.series.length)):1,a=Math.max(i,We),o=e=>k.left+e/Math.max(1,a-1)*Ue;if(e.length===0)return null;let s=Math.max(1,Math.ceil(a/100)),c=Math.ceil(a/s),l=Math.max(3,Ue/c*.6/e.length),u=l*e.length,d=Qe(a,o);return(0,p.jsxs)(`div`,{className:`tline-chart-wrapper`,style:{borderTop:`1px solid rgba(255,255,255,0.06)`,paddingTop:4},children:[(0,p.jsx)(`div`,{style:{padding:`0 16px`,fontSize:12,color:`var(--muted)`,marginBottom:4},children:`成交额`}),(0,p.jsxs)(`svg`,{viewBox:`0 0 ${He} 160`,className:`tline-svg`,preserveAspectRatio:`xMidYMid meet`,children:[[0,.25,.5,.75,1].map(e=>{let t=k.top+(1-e)*r;return(0,p.jsxs)(`g`,{children:[(0,p.jsx)(`line`,{x1:k.left,x2:He-k.right,y1:t,y2:t,className:`tline-grid-line`}),(0,p.jsxs)(`text`,{x:k.left-8,y:t,textAnchor:`end`,dominantBaseline:`middle`,className:`tline-axis-label`,children:[Math.round(e*100),`%`]})]},e)}),e.map((e,t)=>{if(e.series.length===0)return null;let n=Math.max(...e.series.map(e=>e.amount),1);return e.series.filter((e,t)=>t%s===0).map((i,a)=>{let c=o(a*s)-u/2+t*l,d=i.amount/n,f=Math.max(1.5,d*r);return(0,p.jsx)(`rect`,{x:c,y:k.top+r-f,width:Math.max(2,l-1),height:f,fill:e.color,opacity:.7,rx:0},`vol-${e.code}-${a}`)})}),d.map(e=>(0,p.jsx)(`text`,{x:e.x,y:154,textAnchor:`middle`,className:`tline-axis-label`,children:e.label},e.label))]})]})}function Ze({groups:e,seriesMap:t,metaMap:n}){let r=[],i=Object.entries(e);for(let e=0;e<i.length;e++){let[a,o]=i[e];for(let e of o){let i=t.get(e)||[],o=i.length>0?i[i.length-1]:null;r.push({groupName:a,code:e,name:n.get(e)?.name||e,price:o?.price??null,changePct:o?.change??null,volume:o?.amount??null})}}return(0,p.jsxs)(`section`,{className:`panel`,style:{marginTop:16},children:[(0,p.jsx)(`div`,{className:`chart-head`,children:(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`div`,{className:`chart-title`,style:{fontSize:22},children:`实时行情`}),(0,p.jsx)(`div`,{className:`chart-note`,children:`各股票最新价格和涨跌幅`})]})}),(0,p.jsxs)(`table`,{className:`tline-table`,children:[(0,p.jsx)(`thead`,{children:(0,p.jsxs)(`tr`,{children:[(0,p.jsx)(`th`,{children:`分组`}),(0,p.jsx)(`th`,{children:`代码`}),(0,p.jsx)(`th`,{children:`名称`}),(0,p.jsx)(`th`,{children:`最新价`}),(0,p.jsx)(`th`,{children:`涨跌幅`}),(0,p.jsx)(`th`,{children:`成交额`})]})}),(0,p.jsx)(`tbody`,{children:r.map(e=>{let t=e.changePct==null?``:e.changePct>=0?`up`:`down`;return(0,p.jsxs)(`tr`,{children:[(0,p.jsx)(`td`,{children:(0,p.jsx)(`span`,{className:`badge`,children:e.groupName})}),(0,p.jsx)(`td`,{className:`muted`,children:e.code}),(0,p.jsx)(`td`,{children:(0,p.jsx)(`strong`,{children:e.name})}),(0,p.jsx)(`td`,{children:e.price==null?`-`:e.price.toFixed(2)}),(0,p.jsx)(`td`,{className:t,children:e.changePct==null?`-`:et(e.changePct)}),(0,p.jsx)(`td`,{className:`muted`,children:e.volume==null?`-`:tt(e.volume)})]},e.code)})})]})]})}function Qe(e,t){let n=[930,1e3,1030,1100,1130,1300,1330,1400,1430,1500,1530],r=[];for(let i of n){let n;n=i<=1130?(Math.floor(i/100)-9)*60+i%100-30:121+(Math.floor(i/100)-13)*60+i%100,n>=0&&n<e&&r.push({x:t(n),label:$e(i)})}return r}function $e(e){if(e==null)return``;let t=String(e).padStart(4,`0`);return`${t.slice(0,2)}:${t.slice(2,4)}`}function et(e){return e==null?`-`:`${e>=0?`+`:``}${e.toFixed(2)}%`}function tt(e){return e==null?`-`:e>=1e8?`${(e/1e8).toFixed(2)}亿`:e>=1e4?`${(e/1e4).toFixed(0)}万`:String(e)}function nt(){let e=window.location.pathname;return e===`/tline`||e.startsWith(`/tline/`)?`tline`:`home`}function rt(){return nt()===`tline`?(0,p.jsx)(Ge,{}):(0,p.jsx)(Me,{})}(0,u.createRoot)(document.getElementById(`app`)).render((0,p.jsx)(rt,{}));
...
`,_e=!1,ve=null,ye=[`https://cdn.jsdelivr.net/npm/highcharts@12/highcharts.js`,`https://code.highcharts.com/12/highcharts.js`];async function be(){_e||(_e=!0,await xe(),Function(ge)())}function xe(){return window.Highcharts?Promise.resolve():ve||(ve=Se(ye),ve)}function Se(e,t=0){return new Promise((n,r)=>{let i=e[t];if(!i){r(Error(`Highcharts 加载失败`));return}let a=document.querySelector(`script[data-finflow-highcharts="true"]`);if(a){a.addEventListener(`load`,n,{once:!0}),a.addEventListener(`error`,()=>Se(e,t+1).then(n,r),{once:!0});return}let o=document.createElement(`script`);o.src=i,o.async=!0,o.dataset.finflowHighcharts=`true`,o.addEventListener(`load`,n,{once:!0}),o.addEventListener(`error`,()=>{o.remove(),Se(e,t+1).then(n,r)},{once:!0}),document.head.appendChild(o)})}async function Ce(){let e=await fetch(`/api/status`,{cache:`no-store`});if(!e.ok)throw Error(`加载状态失败`);return e.json()}async function we(e){let t=e?`?date=${encodeURIComponent(e)}`:``,n=await fetch(`/api/finance${t}`,{cache:`no-store`});if(!n.ok)throw Error(`加载交易日数据失败`);return n.json()}async function Te({start:e,end:t,limit:n}={}){let r=new URLSearchParams;e&&r.set(`start`,e),t&&r.set(`end`,t),n&&r.set(`limit`,String(n));let i=await fetch(`/api/aggregate?${r.toString()}`,{cache:`no-store`});if(!i.ok){let e=await i.json().catch(()=>({}));throw Error(e.error||`加载区间汇总失败`)}return i.json()}function Ee(){let[e,t]=(0,l.useState)(null),[n,r]=(0,l.useState)(null);(0,l.useEffect)(()=>{let e=!1;async function n(){try{let n=await we();e||(t(n),r(null))}catch(t){e||r(t)}}return n(),()=>{e=!0}},[]);let i=e?Math.max(0,Math.min(e.initialIndex||0,e.samples.length-1)):0,a=e?.samples?.[i]||null;return(0,l.useMemo)(()=>({data:e,error:n,index:i,sample:a,loading:!e&&!n}),[e,n,i,a])}var De=3e4;function Oe(){let[e,t]=(0,l.useState)(null);return(0,l.useEffect)(()=>{let e=!1;async function n(){if(document.visibilityState===`visible`)try{let n=await Ce();e||t(n)}catch{}}n();let r=setInterval(n,De);return document.addEventListener(`visibilitychange`,n),window.addEventListener(`focus`,n),window.addEventListener(`pageshow`,n),()=>{e=!0,clearInterval(r),document.removeEventListener(`visibilitychange`,n),window.removeEventListener(`focus`,n),window.removeEventListener(`pageshow`,n)}},[]),(0,l.useEffect)(()=>{e&&(ke(`status-now`,e.chinaNow?.isoLike||`--`),ke(`status-session`,ne(e.currentTradingSession)),ke(`status-next-run`,re(e.nextRunAt)),ke(`status-samples`,String(e.samplesToday??`--`)))},[e]),e}function ke(e,t){let n=document.getElementById(e);n&&(n.textContent=t)}function Ae(){let e=Oe(),t=Ee();return(0,l.useEffect)(()=>{be().catch(e=>{console.error(e)})},[]),(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`style`,{children:d}),(0,p.jsxs)(`main`,{className:`page`,children:[(0,p.jsx)(de,{status:e}),(0,p.jsx)(ce,{}),(0,p.jsx)(pe,{data:t.data,sample:t.sample,loading:t.loading}),(0,p.jsx)(g,{loading:t.loading}),(0,p.jsx)(ie,{sample:t.sample,loading:t.loading})]}),(0,p.jsx)(O,{})]})}var je=1e4;function Me(){let e=new Date(new Date().toLocaleString(`en-US`,{timeZone:`Asia/Shanghai`})),t=e.getHours(),n=e.getMinutes(),r=e.getDay();if(r===0||r===6)return!1;let i=t*60+n;return i>=540&&i<=695||i>=780&&i<=930}async function Ne(e){let t=await Promise.allSettled(e.map(async e=>{let t=`/api/tline?code=${encodeURIComponent(e)}`,n=await fetch(t,{cache:`no-store`});if(!n.ok)throw Error(`HTTP ${n.status} for ${e}`);return{code:e,data:await n.json()}})),n=new Map;for(let e of t)e.status===`fulfilled`&&n.set(e.value.code,e.value.data);return n}function Pe(e){let t=new URLSearchParams(e),n={};for(let[e,r]of t.entries()){if(!e.startsWith(`group`))continue;let t=r.replace(/^\[|\]$/g,``).trim();if(!t)continue;let i=t.split(`,`).map(e=>e.trim()).filter(Boolean);i.length>0&&(n[e]=i)}return n}function Fe(e){if(!e)return[];let t=e?.data?.line;return Array.isArray(t)?t.map(e=>({time:e.minute,price:e.last_px,avg:e.av_px,volume:e.business_amount,amount:e.business_balance,change:e.change,changePx:e.change_px})):[]}function Ie(e){return e?.data?.name||e?.data?.secu_name||``}function Le(e){return e?.data?.preclose_px??null}function Re(e){let[t,n]=(0,l.useState)(new Map),[r,i]=(0,l.useState)(new Map),[a,o]=(0,l.useState)(!0),[s,c]=(0,l.useState)(null),[u,d]=(0,l.useState)(Me()),f=(0,l.useRef)(null),p=(0,l.useCallback)(async()=>{if(e.length!==0)try{let t=await Ne(e);n(e=>{let n=new Map(e);for(let[e,r]of t)n.set(e,Fe(r));return n}),i(e=>{let n=new Map(e);for(let[e,r]of t)n.set(e,{name:Ie(r),prevClose:Le(r)});return n}),c(null)}catch(e){c(e)}finally{o(!1)}},[e.join(`,`)]);return(0,l.useEffect)(()=>{if(e.length===0){o(!1);return}return o(!0),p(),u&&(f.current=setInterval(p,je)),()=>{f.current&&clearInterval(f.current)}},[p,e.join(`,`),u]),(0,l.useEffect)(()=>{let e=setInterval(()=>{let e=Me();e!==u&&d(e)},6e4);return()=>clearInterval(e)},[u]),{seriesMap:t,metaMap:r,loading:a,error:s,refresh:p,tradingTime:u}}var ze=[`#4f8cff`,`#ff6b6b`,`#51cf66`,`#ffd43b`,`#cc5de8`,`#20c997`,`#ff922b`,`#748ffc`],Be=960,k={top:24,right:80,bottom:36,left:64},Ve=Be-k.left-k.right,He=271;function Ue(){let e=(0,l.useMemo)(()=>Pe(window.location.search),[]),{seriesMap:t,metaMap:n,loading:r,error:i,tradingTime:a}=Re((0,l.useMemo)(()=>{let t=new Set;for(let n of Object.values(e))for(let e of n)t.add(e);return[...t]},[e]));if(Object.keys(e).length===0)return(0,p.jsx)(`main`,{className:`page`,children:(0,p.jsxs)(`section`,{className:`panel`,style:{maxWidth:560,margin:`80px auto`,textAlign:`center`},children:[(0,p.jsx)(`div`,{className:`eyebrow`,children:`Stock Tline Compare`}),(0,p.jsx)(`h1`,{style:{fontSize:28,marginBottom:16},children:`分时对比工具`}),(0,p.jsx)(`p`,{className:`lead`,style:{marginBottom:20},children:`通过 URL 参数指定股票分组，按组对比分时走势和成交量。`}),(0,p.jsx)(`div`,{style:{padding:14,background:`rgba(63,63,70,0.04)`,borderRadius:12,fontFamily:`monospace`,fontSize:13,color:`var(--muted)`},children:`/tline?group1=sz002008,sz300750&group2=sz600519`})]})});let o=Object.entries(e);return(0,p.jsxs)(`main`,{className:`page tline-page`,children:[(0,p.jsx)(We,{groups:e,loading:r,tradingTime:a}),o.map(([e,i],a)=>(0,p.jsx)(Ke,{groupName:e,codes:i,groupIndex:a,seriesMap:t,metaMap:n,loading:r},e)),(0,p.jsx)(Ye,{groups:e,seriesMap:t,metaMap:n}),i&&(0,p.jsxs)(`div`,{className:`tline-error`,children:[`部分数据加载失败：`,i.message]})]})}function We({groups:e,loading:t,tradingTime:n}){let r=Object.values(e).reduce((e,t)=>e+t.length,0),i=n?`交易时段 · 每10秒刷新`:`非交易时段 · 仅加载一次`;return(0,p.jsxs)(`section`,{className:`panel hero-copy`,style:{marginBottom:16},children:[(0,p.jsxs)(`div`,{className:`eyebrow`,children:[`Stock Tline / `,r,` Symbols`]}),(0,p.jsx)(`h1`,{style:{fontSize:48,marginBottom:12},children:`分时走势对比`}),(0,p.jsx)(`p`,{className:`lead`,children:Object.entries(e).map(([e,t])=>(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`strong`,{children:e}),`: `,t.join(`, `),` `]},e))}),(0,p.jsxs)(`div`,{className:`status-rail`,style:{marginTop:16},children:[(0,p.jsx)(Ge,{label:`股票数量`,value:`${r} 只`}),(0,p.jsx)(Ge,{label:`刷新状态`,value:t?`加载中...`:i}),(0,p.jsx)(Ge,{label:`数据状态`,value:n?`🟢 交易中`:`⚪ 休市`}),(0,p.jsx)(Ge,{label:`对比维度`,value:`涨跌幅 %`})]})]})}function Ge({label:e,value:t}){return(0,p.jsxs)(`div`,{className:`status-pill`,children:[(0,p.jsx)(`div`,{className:`label`,children:e}),(0,p.jsx)(`div`,{className:`value`,children:t})]})}function Ke({groupName:e,codes:t,groupIndex:n,seriesMap:r,metaMap:i,loading:a}){let{minPct:o,maxPct:s,lines:c}=(0,l.useMemo)(()=>{let a=1/0,o=-1/0,s=[];for(let c=0;c<t.length;c++){let l=t[c],u=r.get(l)||[],d=i.get(l)||{},f=ze[(n*5+c)%ze.length],p=c>0?`${3+c*2} ${2+c}`:void 0,m=d.prevClose,h=u.map(e=>{if(m&&e.price!=null){let t=(e.price-m)/m*100;return t<a&&(a=t),t>o&&(o=t),{...e,pct:t}}return{...e,pct:0}});s.push({code:l,name:d.name||l,groupName:e,series:h,color:f,dashArray:p})}isFinite(a)||(a=-1,o=1);let c=(o-a)*.1||.5;return{minPct:a-c,maxPct:o+c,lines:s}},[t,n,r,i]);return c.length===0?(0,p.jsx)(`section`,{className:`panel chart-panel`,children:(0,p.jsx)(`div`,{className:`chart-head`,children:(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`div`,{className:`chart-title`,children:e}),(0,p.jsx)(`div`,{className:`chart-note`,children:`暂无数据`})]})})}):(0,p.jsxs)(`section`,{className:`panel chart-panel loading-dim`,"aria-busy":a?`true`:`false`,style:{marginBottom:16},children:[(0,p.jsx)(`div`,{className:`chart-head`,children:(0,p.jsxs)(`div`,{children:[(0,p.jsxs)(`div`,{className:`chart-title`,style:{display:`flex`,alignItems:`center`,gap:10},children:[(0,p.jsx)(`span`,{className:`badge`,style:{fontSize:14,padding:`2px 10px`},children:e}),(0,p.jsx)(`span`,{children:`分时走势 + 成交量`})]}),(0,p.jsx)(`div`,{className:`chart-stats`,style:{marginTop:6},children:c.map(e=>(0,p.jsxs)(`span`,{className:`chart-legend-item`,style:{color:e.color},children:[(0,p.jsx)(`span`,{className:`chart-legend-swatch`,style:{background:e.color}}),e.name]},e.code))})]})}),(0,p.jsx)(qe,{lines:c,minPct:o,maxPct:s}),(0,p.jsx)(Je,{lines:c,seriesMap:r,codes:t})]})}function qe({lines:e,minPct:t,maxPct:n}){let[r,i]=(0,l.useState)(null),a=(0,l.useRef)(null),o=320-k.top-k.bottom,s=e.length>0?Math.max(...e.map(e=>e.series.length)):1,c=Math.max(s,He),u=e=>k.left+e/Math.max(1,c-1)*Ve,d=e=>k.top+(n-e)/(n-t)*o,f=(0,l.useCallback)(t=>{if(!a.current||e.length===0)return;let n=a.current.getBoundingClientRect(),r=(t.clientX-n.left)/n.width*Be,o=Math.round((r-k.left)/Ve*(c-1));if(o<0||o>=c){i(null);return}let s=e.map(e=>{let t=e.series[o];return t?{name:e.name,color:e.color,price:t.price,pct:t.pct,time:t.time,amount:t.amount}:null}).filter(Boolean);if(s.length===0){i(null);return}i({x:u(o),time:s[0]?.time,items:s,side:u(o)>Be/2?`left`:`right`})},[e,c,Be,Ve,u]),m=(0,l.useCallback)(()=>i(null),[]),h=[],g=(n-t)/5;for(let e=0;e<=5;e++)h.push(t+g*e);let _=t<=0&&n>=0?d(0):null,v=Xe(c,u);return(0,p.jsxs)(`div`,{className:`tline-chart-wrapper`,style:{position:`relative`},children:[(0,p.jsx)(`div`,{style:{padding:`0 16px`,fontSize:12,color:`var(--muted)`,marginBottom:4},children:`涨跌幅 (%)`}),(0,p.jsxs)(`svg`,{ref:a,viewBox:`0 0 ${Be} 320`,className:`tline-svg`,preserveAspectRatio:`xMidYMid meet`,onMouseMove:f,onMouseLeave:m,style:{cursor:`crosshair`},children:[h.map(e=>(0,p.jsxs)(`g`,{children:[(0,p.jsx)(`line`,{x1:k.left,x2:Be-k.right,y1:d(e),y2:d(e),className:`tline-grid-line`}),(0,p.jsxs)(`text`,{x:k.left-8,y:d(e),textAnchor:`end`,dominantBaseline:`middle`,className:`tline-axis-label`,children:[e>=0?`+`:``,e.toFixed(2),`%`]})]},e)),_!=null&&(0,p.jsxs)(`g`,{children:[(0,p.jsx)(`line`,{x1:k.left,x2:Be-k.right,y1:_,y2:_,className:`tline-prev-close`}),(0,p.jsx)(`text`,{x:Be-k.right+6,y:_,dominantBaseline:`middle`,className:`tline-axis-label`,style:{fontSize:10},children:`0%`})]}),e.map(e=>e.series.length===0?null:(0,p.jsx)(`path`,{d:e.series.map((e,t)=>`${t===0?`M`:`L`}${u(t)},${d(e.pct)}`).join(` `),fill:`none`,stroke:e.color,strokeWidth:1.8,strokeDasharray:e.dashArray,className:`tline-path`},e.code)),e.map(e=>{if(e.series.length===0)return null;let t=e.series.length-1;return(0,p.jsx)(`circle`,{cx:u(t),cy:d(e.series[t].pct),r:4,fill:e.color,stroke:`rgba(24,24,27,0.9)`,strokeWidth:2},`dot-${e.code}`)}),v.map(e=>(0,p.jsx)(`text`,{x:e.x,y:314,textAnchor:`middle`,className:`tline-axis-label`,children:e.label},e.label)),r&&(0,p.jsxs)(`g`,{children:[(0,p.jsx)(`line`,{x1:r.x,x2:r.x,y1:k.top,y2:320-k.bottom,stroke:`rgba(244,244,245,0.3)`,strokeWidth:1,strokeDasharray:`4 4`,pointerEvents:`none`}),r.items.map((e,t)=>(0,p.jsx)(`circle`,{cx:r.x,cy:d(e.pct),r:5,fill:e.color,stroke:`rgba(24,24,27,0.9)`,strokeWidth:2,pointerEvents:`none`},t))]}),(0,p.jsx)(`rect`,{x:k.left,y:k.top,width:Ve,height:o,fill:`transparent`})]}),r&&(0,p.jsxs)(`div`,{className:`tline-tooltip`,style:{position:`absolute`,top:10,[r.side===`left`?`right`:`left`]:90,pointerEvents:`none`},children:[(0,p.jsx)(`div`,{className:`tline-tooltip-time`,children:Ze(r.time)}),r.items.map((e,t)=>(0,p.jsxs)(`div`,{className:`tline-tooltip-row`,children:[(0,p.jsx)(`span`,{className:`tline-tooltip-dot`,style:{background:e.color}}),(0,p.jsx)(`span`,{className:`tline-tooltip-name`,children:e.name}),(0,p.jsxs)(`span`,{className:`tline-tooltip-pct`,style:{color:e.pct>=0?`var(--up)`:`var(--down)`},children:[e.pct>=0?`+`:``,e.pct.toFixed(2),`%`]}),(0,p.jsx)(`span`,{className:`tline-tooltip-price`,children:e.price?.toFixed(2)})]},t))]})]})}function Je({lines:e,seriesMap:t,codes:n}){let r=160-k.top-k.bottom,i=e.length>0?Math.max(...e.map(e=>e.series.length)):1,a=Math.max(i,He),o=e=>k.left+e/Math.max(1,a-1)*Ve;if(e.length===0)return null;let s=Math.max(1,Math.ceil(a/100)),c=Math.ceil(a/s),l=Math.max(3,Ve/c*.6/e.length),u=l*e.length,d=Xe(a,o);return(0,p.jsxs)(`div`,{className:`tline-chart-wrapper`,style:{borderTop:`1px solid rgba(255,255,255,0.06)`,paddingTop:4},children:[(0,p.jsx)(`div`,{style:{padding:`0 16px`,fontSize:12,color:`var(--muted)`,marginBottom:4},children:`成交额`}),(0,p.jsxs)(`svg`,{viewBox:`0 0 ${Be} 160`,className:`tline-svg`,preserveAspectRatio:`xMidYMid meet`,children:[[0,.25,.5,.75,1].map(e=>{let t=k.top+(1-e)*r;return(0,p.jsxs)(`g`,{children:[(0,p.jsx)(`line`,{x1:k.left,x2:Be-k.right,y1:t,y2:t,className:`tline-grid-line`}),(0,p.jsxs)(`text`,{x:k.left-8,y:t,textAnchor:`end`,dominantBaseline:`middle`,className:`tline-axis-label`,children:[Math.round(e*100),`%`]})]},e)}),e.map((e,t)=>{if(e.series.length===0)return null;let n=Math.max(...e.series.map(e=>e.amount),1);return e.series.filter((e,t)=>t%s===0).map((i,a)=>{let c=o(a*s)-u/2+t*l,d=i.amount/n,f=Math.max(1.5,d*r);return(0,p.jsx)(`rect`,{x:c,y:k.top+r-f,width:Math.max(2,l-1),height:f,fill:e.color,opacity:.7,rx:0},`vol-${e.code}-${a}`)})}),d.map(e=>(0,p.jsx)(`text`,{x:e.x,y:154,textAnchor:`middle`,className:`tline-axis-label`,children:e.label},e.label))]})]})}function Ye({groups:e,seriesMap:t,metaMap:n}){let r=[],i=Object.entries(e);for(let e=0;e<i.length;e++){let[a,o]=i[e];for(let e of o){let i=t.get(e)||[],o=i.length>0?i[i.length-1]:null;r.push({groupName:a,code:e,name:n.get(e)?.name||e,price:o?.price??null,changePct:o?.change??null,volume:o?.amount??null})}}return(0,p.jsxs)(`section`,{className:`panel`,style:{marginTop:16},children:[(0,p.jsx)(`div`,{className:`chart-head`,children:(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`div`,{className:`chart-title`,style:{fontSize:22},children:`实时行情`}),(0,p.jsx)(`div`,{className:`chart-note`,children:`各股票最新价格和涨跌幅`})]})}),(0,p.jsxs)(`table`,{className:`tline-table`,children:[(0,p.jsx)(`thead`,{children:(0,p.jsxs)(`tr`,{children:[(0,p.jsx)(`th`,{children:`分组`}),(0,p.jsx)(`th`,{children:`代码`}),(0,p.jsx)(`th`,{children:`名称`}),(0,p.jsx)(`th`,{children:`最新价`}),(0,p.jsx)(`th`,{children:`涨跌幅`}),(0,p.jsx)(`th`,{children:`成交额`})]})}),(0,p.jsx)(`tbody`,{children:r.map(e=>{let t=e.changePct==null?``:e.changePct>=0?`up`:`down`;return(0,p.jsxs)(`tr`,{children:[(0,p.jsx)(`td`,{children:(0,p.jsx)(`span`,{className:`badge`,children:e.groupName})}),(0,p.jsx)(`td`,{className:`muted`,children:e.code}),(0,p.jsx)(`td`,{children:(0,p.jsx)(`strong`,{children:e.name})}),(0,p.jsx)(`td`,{children:e.price==null?`-`:e.price.toFixed(2)}),(0,p.jsx)(`td`,{className:t,children:e.changePct==null?`-`:Qe(e.changePct)}),(0,p.jsx)(`td`,{className:`muted`,children:e.volume==null?`-`:$e(e.volume)})]},e.code)})})]})]})}function Xe(e,t){let n=[930,1e3,1030,1100,1130,1300,1330,1400,1430,1500,1530],r=[];for(let i of n){let n;n=i<=1130?(Math.floor(i/100)-9)*60+i%100-30:121+(Math.floor(i/100)-13)*60+i%100,n>=0&&n<e&&r.push({x:t(n),label:Ze(i)})}return r}function Ze(e){if(e==null)return``;let t=String(e).padStart(4,`0`);return`${t.slice(0,2)}:${t.slice(2,4)}`}function Qe(e){return e==null?`-`:`${e>=0?`+`:``}${e.toFixed(2)}%`}function $e(e){return e==null?`-`:e>=1e8?`${(e/1e8).toFixed(2)}亿`:e>=1e4?`${(e/1e4).toFixed(0)}万`:String(e)}var et=[10,15,20];function tt(){let e=(0,l.useMemo)(()=>new URLSearchParams(window.location.search),[]),[t,n]=(0,l.useState)(e.get(`start`)||``),[r,i]=(0,l.useState)(e.get(`end`)||``),[a,o]=(0,l.useState)(e.get(`limit`)||`10`),[s,c]=(0,l.useState)(`percentile`),[u,f]=(0,l.useState)(null),[m,h]=(0,l.useState)(null),[g,_]=(0,l.useState)(!0),v=(0,l.useCallback)(async(e,t,r)=>{_(!0),h(null);try{let a=await Te({start:e,end:t,limit:r});f(a),e||n(a.range.start),t||i(a.range.end),o(String(a.limit));let s=new URLSearchParams;s.set(`start`,a.range.start),s.set(`end`,a.range.end),s.set(`limit`,String(a.limit)),window.history.replaceState(null,``,`/aggregate?`+s.toString())}catch(e){h(e),f(null)}finally{_(!1)}},[]);(0,l.useEffect)(()=>{v(t,r,a)},[]),(0,l.useEffect)(()=>(document.body.dataset.loading=g?`true`:`false`,()=>{delete document.body.dataset.loading}),[g]);let y=new URLSearchParams;u&&(y.set(`start`,u.range.start),y.set(`end`,u.range.end),y.set(`limit`,String(u.limit)));let b=`/aggregate.md?`+y.toString(),x=u?ot(u,s):null;return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`style`,{children:d}),(0,p.jsxs)(`main`,{className:`page aggregate-page`,children:[(0,p.jsxs)(`section`,{className:`hero`,children:[(0,p.jsxs)(`article`,{className:`panel hero-copy`,children:[(0,p.jsx)(`div`,{className:`eyebrow`,children:`Concept Flow / Range Aggregate`}),(0,p.jsxs)(`h1`,{children:[`一段时间里，`,(0,p.jsx)(`br`,{}),`资金到底在往哪搬。`]}),(0,p.jsx)(`p`,{className:`lead`,children:`按区间汇总每个交易日的收盘资金快照，用当日横截面分位数消除概念规模差异， 再对比前后半段找出资金真正的迁移方向。`}),(0,p.jsxs)(`p`,{className:`lead`,style:{marginTop:14},children:[(0,p.jsx)(`a`,{className:`nav-link`,href:`/`,children:`← 回到日内回放`}),(0,p.jsx)(`a`,{className:`nav-link aggregate-md-link`,href:b,children:`Markdown 输出 →`})]})]}),(0,p.jsxs)(`article`,{className:`panel hero-side`,children:[(0,p.jsxs)(`div`,{className:`flex items-start justify-between gap-3`,children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`div`,{className:`metric-label`,children:`统计区间`}),(0,p.jsx)(`div`,{className:`metric-value aggregate-range`,id:`m-range`,children:u?`${u.range.start} → ${u.range.end}`:`--`})]}),(0,p.jsxs)(`button`,{type:`button`,"aria-label":`切换明暗主题`,"data-tooltip":`切换主题`,"data-side":`bottom`,onClick:()=>document.dispatchEvent(new CustomEvent(`basecoat:theme`)),className:`btn-icon-outline size-8`,children:[(0,p.jsx)(`span`,{className:`hidden dark:block`,children:(0,p.jsx)(ut,{})}),(0,p.jsx)(`span`,{className:`block dark:hidden`,children:(0,p.jsx)(dt,{})})]})]}),(0,p.jsx)(`p`,{className:`aggregate-note`,style:{marginTop:14},id:`m-excluded`,children:u?u.excludedDates.length?`已剔除 ${u.excludedDates.length} 个采集中断日：${u.excludedDates.join(`、`)}`:`区间内所有交易日均取到有效收盘快照。`:`正在读取区间数据...`})]})]}),(0,p.jsxs)(`section`,{className:`panel aggregate-controls`,children:[(0,p.jsxs)(`div`,{className:`aggregate-control-field`,children:[(0,p.jsx)(`span`,{className:`metric-label`,children:`开始日期`}),(0,p.jsx)(`input`,{type:`date`,className:`input`,value:t,onChange:e=>n(e.target.value)})]}),(0,p.jsxs)(`div`,{className:`aggregate-control-field`,children:[(0,p.jsx)(`span`,{className:`metric-label`,children:`结束日期`}),(0,p.jsx)(`input`,{type:`date`,className:`input`,value:r,onChange:e=>i(e.target.value)})]}),(0,p.jsxs)(`div`,{className:`aggregate-control-field`,children:[(0,p.jsx)(`span`,{className:`metric-label`,children:`榜单条数`}),(0,p.jsx)(`select`,{className:`input`,value:a,onChange:e=>o(e.target.value),children:et.map(e=>(0,p.jsxs)(`option`,{value:String(e),children:[`前后各 `,e]},e))})]}),(0,p.jsxs)(`div`,{className:`aggregate-control-field`,children:[(0,p.jsx)(`span`,{className:`metric-label`,children:`排序口径`}),(0,p.jsxs)(`select`,{className:`input`,value:s,onChange:e=>c(e.target.value),children:[(0,p.jsx)(`option`,{value:`percentile`,children:`资金分位（推荐）`}),(0,p.jsx)(`option`,{value:`netflow`,children:`累计净额`}),(0,p.jsx)(`option`,{value:`change`,children:`区间涨跌幅`})]})]}),(0,p.jsxs)(`div`,{className:`aggregate-control-field`,children:[(0,p.jsx)(`span`,{className:`metric-label`,children:`\xA0`}),(0,p.jsx)(`button`,{type:`button`,className:`btn`,onClick:()=>v(t,r,a),children:`应用`})]})]}),(0,p.jsxs)(`section`,{className:`metric-grid`,children:[(0,p.jsxs)(`article`,{className:`panel`,children:[(0,p.jsx)(`div`,{className:`metric-label`,children:`交易日`}),(0,p.jsx)(`div`,{className:`metric-value`,children:u?`${u.tradingDays} 天`:`--`})]}),(0,p.jsxs)(`article`,{className:`panel`,children:[(0,p.jsx)(`div`,{className:`metric-label`,children:`概念数`}),(0,p.jsx)(`div`,{className:`metric-value`,children:u?u.conceptCount:`--`})]}),(0,p.jsxs)(`article`,{className:`panel`,children:[(0,p.jsx)(`div`,{className:`metric-label`,children:`区间最强`}),(0,p.jsx)(`div`,{className:`metric-value aggregate-name`,children:u?.favored?.[0]?.name||`--`})]}),(0,p.jsxs)(`article`,{className:`panel`,children:[(0,p.jsx)(`div`,{className:`metric-label`,children:`区间最弱`}),(0,p.jsx)(`div`,{className:`metric-value aggregate-name`,children:u?.abandoned?.[0]?.name||`--`})]})]}),m&&(0,p.jsx)(`section`,{className:`panel aggregate-error`,children:m.message}),u&&(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(nt,{topTitle:x.topTitle,bottomTitle:x.bottomTitle,topNote:x.topNote,bottomNote:x.bottomNote,topRows:x.top,bottomRows:x.bottom}),(0,p.jsx)(rt,{data:u}),(0,p.jsxs)(`section`,{className:`panel`,children:[(0,p.jsx)(`div`,{className:`aggregate-board-title`,children:(0,p.jsx)(`h2`,{children:`口径说明`})}),(0,p.jsxs)(`p`,{className:`aggregate-note`,children:[(0,p.jsx)(`strong`,{children:`资金分位`}),`：每个交易日把当日已保存的概念按主力资金净额排序，取该概念所处位置 （0 = 当日最差，100 = 当日最好），再对区间内所有交易日求平均。 之所以不直接累加 `,(0,p.jsx)(`code`,{children:`mainFundDiff`}),`，是因为成分股多的概念绝对净额天然偏大，且全市场主力净额结构性为负， 直接累加排出来的是“概念规模榜”而非资金偏好榜。`,(0,p.jsx)(`br`,{}),(0,p.jsx)(`strong`,{children:`数据范围`}),`：本站每个快照只保存主力净额 Top10 + Bottom10 共 20 个信号概念， 分位排名是在当日已保存概念集合内计算的相对位置，未上榜概念不参与排名。`,(0,p.jsx)(`br`,{}),(0,p.jsx)(`strong`,{children:`区间涨跌幅`}),`：`,(0,p.jsx)(`code`,{children:`change`}),` 是`,(0,p.jsx)(`strong`,{children:`单日`}),`盘中涨幅，每日归零重算， 因此按复利连乘 `,(0,p.jsx)(`code`,{children:`Π(1+change)-1`}),` 计算，简单相加会明显夸大跌幅。`,(0,p.jsx)(`br`,{}),(0,p.jsx)(`strong`,{children:`收盘口径`}),`：采集在 15:00 停止，每个交易日取最后一个快照作为收盘快照。 若最后快照早于 14:55（采集中断），当日资金被低估，已从统计中剔除。`,(0,p.jsx)(`br`,{}),(0,p.jsx)(`strong`,{children:`持续加仓 / 撤退`}),`：把区间等分为前后两段，对比同一概念的平均资金分位变化。 月末的静态排名说明“钱停在哪”，而分位变化说明“钱在往哪走”。`]})]})]})]})]})}function nt({topTitle:e,bottomTitle:t,topNote:n,bottomNote:r,topRows:i,bottomRows:a}){return(0,p.jsxs)(`section`,{className:`aggregate-board-grid`,children:[(0,p.jsxs)(`article`,{className:`panel`,children:[(0,p.jsx)(`div`,{className:`aggregate-board-title`,children:(0,p.jsx)(`h2`,{children:e})}),(0,p.jsx)(`p`,{className:`aggregate-note`,children:n}),(0,p.jsx)(it,{rows:i})]}),(0,p.jsxs)(`article`,{className:`panel`,children:[(0,p.jsx)(`div`,{className:`aggregate-board-title`,children:(0,p.jsx)(`h2`,{children:t})}),(0,p.jsx)(`p`,{className:`aggregate-note`,children:r}),(0,p.jsx)(it,{rows:a})]})]})}function rt({data:e}){let t=e.trend,n=!!(t&&t.first),r=n?`前段 ${t.first.start}~${t.first.end}（${t.first.days}天） 对比 后段 ${t.second.start}~${t.second.end}（${t.second.days}天）`:`区间过短，无法做前后段对比（至少需要 4 个交易日）。`;return(0,p.jsxs)(`section`,{className:`aggregate-board-grid`,children:[(0,p.jsxs)(`article`,{className:`panel`,children:[(0,p.jsx)(`div`,{className:`aggregate-board-title`,children:(0,p.jsx)(`h2`,{children:`资金持续加仓`})}),(0,p.jsxs)(`p`,{className:`aggregate-note`,children:[`后段资金分位显著抬升的概念。`,r]}),(0,p.jsx)(at,{rows:n?t.rising:[]})]}),(0,p.jsxs)(`article`,{className:`panel`,children:[(0,p.jsx)(`div`,{className:`aggregate-board-title`,children:(0,p.jsx)(`h2`,{children:`资金持续撤退`})}),(0,p.jsxs)(`p`,{className:`aggregate-note`,children:[`后段资金分位显著回落的概念。`,r]}),(0,p.jsx)(at,{rows:n?t.falling:[]})]})]})}function it({rows:e}){return!e||!e.length?(0,p.jsx)(`div`,{className:`aggregate-empty`,children:`该区间暂无数据`}):(0,p.jsxs)(`table`,{className:`aggregate-table`,children:[(0,p.jsx)(`thead`,{children:(0,p.jsxs)(`tr`,{children:[(0,p.jsx)(`th`,{children:`概念`}),(0,p.jsx)(`th`,{children:`资金分位`}),(0,p.jsx)(`th`,{className:`aggregate-bar-cell`}),(0,p.jsx)(`th`,{children:`累计净额`}),(0,p.jsx)(`th`,{children:`涨跌幅`}),(0,p.jsx)(`th`,{children:`正流入`})]})}),(0,p.jsx)(`tbody`,{children:e.map((e,t)=>{let n=Math.max(0,Math.min(100,e.percentile));return(0,p.jsxs)(`tr`,{children:[(0,p.jsxs)(`td`,{children:[(0,p.jsx)(`span`,{className:`aggregate-rank`,children:t+1}),(0,p.jsx)(`span`,{className:`aggregate-cname`,children:e.name}),e.leaderStock&&(0,p.jsx)(`span`,{className:`aggregate-cleader`,children:e.leaderStock})]}),(0,p.jsx)(`td`,{children:e.percentile.toFixed(1)}),(0,p.jsx)(`td`,{className:`aggregate-bar-cell`,children:(0,p.jsx)(`div`,{className:`aggregate-bar`,children:(0,p.jsx)(`span`,{style:{width:`${n}%`}})})}),(0,p.jsx)(`td`,{className:lt(e.netFlow),children:st(e.netFlow)}),(0,p.jsx)(`td`,{className:lt(e.change),children:ct(e.change)}),(0,p.jsxs)(`td`,{className:`muted`,children:[e.positiveDays,`/`,e.days]})]},e.code||e.name)})})]})}function at({rows:e}){return!e||!e.length?(0,p.jsx)(`div`,{className:`aggregate-empty`,children:`该区间暂无数据`}):(0,p.jsxs)(`table`,{className:`aggregate-table`,children:[(0,p.jsx)(`thead`,{children:(0,p.jsxs)(`tr`,{children:[(0,p.jsx)(`th`,{children:`概念`}),(0,p.jsx)(`th`,{children:`分位变化`}),(0,p.jsx)(`th`,{children:`前段`}),(0,p.jsx)(`th`,{children:`后段`}),(0,p.jsx)(`th`,{children:`涨跌幅`})]})}),(0,p.jsx)(`tbody`,{children:e.map((e,t)=>(0,p.jsxs)(`tr`,{children:[(0,p.jsxs)(`td`,{children:[(0,p.jsx)(`span`,{className:`aggregate-rank`,children:t+1}),(0,p.jsx)(`span`,{className:`aggregate-cname`,children:e.name})]}),(0,p.jsxs)(`td`,{className:e.delta>0?`up`:`down`,children:[e.delta>0?`+`:``,e.delta.toFixed(1)]}),(0,p.jsx)(`td`,{className:`muted`,children:e.firstHalf.toFixed(1)}),(0,p.jsx)(`td`,{children:e.secondHalf.toFixed(1)}),(0,p.jsx)(`td`,{className:lt(e.change),children:ct(e.change)})]},e.code||e.name))})]})}function ot(e,t){return t===`netflow`?{top:e.topNetFlow,bottom:e.bottomNetFlow,topTitle:`净流入 TOP${e.limit}`,bottomTitle:`净流出 BOTTOM${e.limit}`,topNote:`按区间累计主力资金净额排序。注意该口径受概念规模影响，成分股越多绝对值越大。`,bottomNote:`按区间累计主力资金净额倒序。绝对值大的多为大型概念，不代表相对弱势。`}:t===`change`?{top:e.topChange,bottom:e.bottomChange,topTitle:`区间涨幅 TOP${e.limit}`,bottomTitle:`区间跌幅 BOTTOM${e.limit}`,topNote:`按日涨幅复利连乘计算的区间收益，与资金口径互相独立，可用于交叉验证。`,bottomNote:`按日涨幅复利连乘计算的区间收益。价格跌但资金分位高，属于背离信号。`}:{top:e.favored,bottom:e.abandoned,topTitle:`资金最青睐 TOP${e.limit}`,bottomTitle:`资金最抛弃 BOTTOM${e.limit}`,topNote:`按日均横截面分位数排序，已消除概念规模影响。分位越高代表几乎每天都比同批信号概念强。`,bottomNote:`日均分位最低的概念，代表在区间内被资金持续冷落。`}}function st(e){if(!Number.isFinite(e))return`--`;let t=e/1e8;return Math.abs(t)>=1e3?t.toFixed(0)+`亿`:t.toFixed(1)+`亿`}function ct(e){return Number.isFinite(e)?(e*100).toFixed(1)+`%`:`--`}function lt(e){return!Number.isFinite(e)||e===0?`muted`:e>0?`up`:`down`}function ut(){return(0,p.jsxs)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,width:`18`,height:`18`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,children:[(0,p.jsx)(`circle`,{cx:`12`,cy:`12`,r:`4`}),(0,p.jsx)(`path`,{d:`M12 2v2`}),(0,p.jsx)(`path`,{d:`M12 20v2`}),(0,p.jsx)(`path`,{d:`m4.93 4.93 1.41 1.41`}),(0,p.jsx)(`path`,{d:`m17.66 17.66 1.41 1.41`}),(0,p.jsx)(`path`,{d:`M2 12h2`}),(0,p.jsx)(`path`,{d:`M20 12h2`}),(0,p.jsx)(`path`,{d:`m6.34 17.66-1.41 1.41`}),(0,p.jsx)(`path`,{d:`m19.07 4.93-1.41 1.41`})]})}function dt(){return(0,p.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,width:`18`,height:`18`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,children:(0,p.jsx)(`path`,{d:`M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z`})})}function ft(){let e=window.location.pathname;return e===`/tline`||e.startsWith(`/tline/`)?`tline`:e===`/aggregate`?`aggregate`:`home`}function pt(){let e=ft();return e===`tline`?(0,p.jsx)(Ue,{}):e===`aggregate`?(0,p.jsx)(tt,{}):(0,p.jsx)(Ae,{})}(0,u.createRoot)(document.getElementById(`app`)).render((0,p.jsx)(pt,{}));